...
class HomeController extends Controller
{
    ...
    public function run()
    {
        $filePath = "/Volumes/DATA/vci/scholar/news_1302/vci-scholar/resource_doc/dump/dump_jsvnu/ER";
    ...
    {
        $journal = $this->findOrCreateJournal($result["journalTitle"]);
...
//        }
    ...
    private function extractAuthorsArray($authors)
    {
     ...
     */
    private function createAuthor($article, $authors_data, $affiliationsList)
    {
...
//                        }
     ...
     * @param $affiliationsList
     */
    private function createListAffiliationList($affiliationsList)
    {
