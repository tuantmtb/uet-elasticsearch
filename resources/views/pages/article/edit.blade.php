...
@section('page-title', 'Sửa bài báo')
        ...
        <div class="col-md-12">
            <div class="portlet light">
                ...
                <div class="portlet-body form">
                    {{Form::model($article, ['method' => 'post', 'route' => ['article.update', $article->id], 'role' => 'form', 'id' => 'form'])}}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="form-group  col-md-8 {{ $errors->has('journal_id') ? ' has-error' : '' }}">
                                    ...
                                    {{Form::select('journal_id', $journals, null, ['class' => 'form-control'])}}
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    @if(Session::hasOldInput('authors'))
                                    ...
                                    @else
                                        @foreach($article->authors as $author)
                                            <div class="row margin-top-10">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" value="{{$author->firstOrganize() ? $author->firstOrganize()->name : ''}}" class="form-control array-2d" placeholder="Cơ quan" data-dim-1="authors" data-attr="organize_name">
                                                </div>
                                                <div class="col-md-1">
                                                    <button class="btn btn-sm red author-remove" type="button">
                                                        <i class="fa fa-close"></i>
