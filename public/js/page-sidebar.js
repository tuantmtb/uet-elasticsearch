...
var Sidebar = function () {
        ...
        $('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    Sidebar.fixContentHeight(); // fix content height
    ...
    var handleSidebarToggler = function () {
        ...
        var handleSidebarCollapse = function() {
            ...
            $('.nav-item').not('.sidebar-toggler-wrapper').slideToggle(200, function() {
                leftCol.removeClass('col-md-3').addClass('col-md-1');
                rightCol.removeClass('col-md-9').addClass('col-md-11');
            });
        };

        var handleSidebarExpand = function() {
            body.removeClass("page-sidebar-closed");
            sidebarMenu.removeClass("page-sidebar-menu-closed");

            leftCol.removeClass('col-md-1').addClass('col-md-3');
            rightCol.removeClass('col-md-11').addClass('col-md-9');
            if (App.getViewPort().width >= resBreakpointMd) {
                $('.nav-item').not('.sidebar-toggler-wrapper').delay(300).slideToggle(200);
            } else {
                $('.nav-item').not('.sidebar-toggler-wrapper').slideToggle(200);
            }
        };
...
if (App.isAngularJsApp() === false) {
    jQuery(document).ready(function() {
        Sidebar.init(); // init metronic core componets
    });
}